...
const Rules = ({ nextStep }) => {
  return (
    <div className='h-full flex justify-center items-center animate-zoomIn min-h-inherit'>
      <div className='relative flex flex-col space-y-10 tv:space-y-10 w-[90%] md:w-[70%] tv:w-[90%] bg-yellow rounded-[150px] md:rounded-full tv:rounded-[300px] py-24 px-12 tv:py-64 tv:px-28 text-center min-h-[50%]'>
        ...
        <div
          className={`bg-blue mt-8 tv:mt-0 w-min m-auto px-6 py-3 tv:py-4 tv:px-12 rounded-full cursor-custom animate-remind-lightening transition hover:animate-lightening opacity-1`}
          onClick={nextStep}>
