...
const Rules = ({ nextStep }) => {
  return (
    <div className='h-full flex justify-center items-center animate-zoomIn min-h-inherit'>
      <div className='relative flex flex-col space-y-10 tv:space-y-44 w-[90%] md:w-[70%] tv:w-[90%] bg-yellow rounded-[150px] md:rounded-full tv:rounded-[300px] py-24 px-12 tv:py-40 tv:px-28 text-center min-h-[50%]'>
        <RulesLogo className='md:w-[50%] w-[90%] tv:w-[95%] m-auto translate-x-3 md:translate-x-0 translate-y-3 tv:pt-20' />
        <div className='py-4 text-sm md:text-base tv:text-4xl tv:py-20'>
          請試著回想一個讓你印象深刻的夢，可以是任何的情境
          <br />
          不管傷心難過、開心快樂甚至是難以啟齒的夢，都請回答接下來的問題！
          <br />
          <div className='py-3 text-sm md:text-base tv:text-4xl tv:py-10'>
