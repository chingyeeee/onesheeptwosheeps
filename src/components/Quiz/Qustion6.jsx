...
const Option = ({ opt, optText, Image, handleSaveAns, otherAns, i }) => {
  return (
    <div
      ...
      <Image
        className={`w-[46%] md:w-[63%] tv:w-[85%] group-hover:block group-hover:fill-yellow ${
...
const Question6 = ({ questionNum, setQuestionNum, handleSaveAns, otherAns }) => {
  ...
  return (
    <div
      ...
      {questionNum === 6 && (
        <>
          <div className='flex flex-col-reverse md:flex-row tv:flex-col-reverse gap-2 md:gap-6 items-start justify-between tv:mt-52'>
          ...
          <div className='md:flex items-end justify-between md:h-[36%] tv:block tv:mt-40 tv:h-[20%] mt-8 md:mt-0'>
            <div className='w-[60%] md:w-[30%] tv:w-[60%] flex flex-col font-semibold md:h-full tv:h-[70%] divide-y-2 divide-black border-y-2 border-black'>
            ...
            {!!otherAns[2] && (
              <div className='w-[60%] md:w-[30%] md:ml-[5%] tv:w-[60%] tv:ml-0 flex flex-col font-semibold md:h-full tv:h-[70%] divide-y-2 divide-black md:border-y-2 border-b-2 border-black'>
