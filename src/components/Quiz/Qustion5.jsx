        ...
        <>
          <div className='flex flex-col justify-between h-full'>
            ...
            <div className='flex flex-col-reverse items-start md:flex-row md:items-end justify-center md:justify-between gap-16 md:gap-24 w-[100%] mx-auto md:h-[48%]'>
              <Title5 className='w-[23%] ml-auto md:w-[15%] md:ml-0' />
              <div className='w-full md:h-full md:w-[55%] justify-between flex flex-col font-semibold mt-4 md:mt-0 divide-y-2 divide-black border-y-2 border-black'>
