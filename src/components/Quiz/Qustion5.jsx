...
const Option = ({ opt, optText, optTextEng, Image, handleSaveAns, quizAns }) => {
  return (
    <div
      ...
      {
        <Image
          className={`w-[80%] md:w-[63%] -translate-x-2 md:-translate-x-5 group-hover:block group-hover:fill-blue ${
...
const Question5 = ({ questionNum, setQuestionNum, handleSaveAns, quizAns }) => {
  return (
    <div
      ...
      {questionNum === 5 && (
        <>
          <div className='flex flex-col justify-between tv:justify-normal h-full tv:mt-80'>
            ...
            <div className='flex flex-col-reverse tv:flex-col-reverse items-start tv:items-start md:flex-row md:items-end justify-center tv:justify-center md:justify-between gap-16 md:gap-24 tv:gap-72 tv:pt-10 w-full mx-auto md:h-[48%] tv:h-auto'>
              <Title5 className='w-[23%] ml-auto md:w-[15%] md:ml-0 tv:ml-auto tv:w-[28%]' />
