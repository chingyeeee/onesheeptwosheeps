...
const Option = ({ opt, optText, optTextEng, Image, handleSaveAns, quizAns }) => {
  return (
    <div
      className={`flex justify-between text-base md:text-xl tv:text-3xl p-2 tv:p-5 cursor-custom group hover:bg-black items-center flex-1 transition duration-500 ${
      ...
      {
        <Image
          className={`w-[46%] md:w-[63%] tv:w-[60%] group-hover:block group-hover:fill-lakegreen ${
  ...
  return (
    <div
      ...
      <div
        ...
        } flex justify-between md:text-xl tv:text-3xl absolute inset-x-0 h-min bottom-1 md:bottom-1.5 tv:bottom-1 tv:px-4 font-chakra px-4 md:px-8 hover:italic cursor-custom`}
