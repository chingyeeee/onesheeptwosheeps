  ...
  return (
    <Fragment>
      ...
      <div
        ...
        <div className='absolute z-[30] w-[10%] bottom-[15%] left-10 md:left-auto md:bottom-0 md:top-[30%] flex flex-col gap-7 items-center'>
          <div
            ...
            <p className='text-[8px] md:text-base font-bold underline underline-black w-max'>
              add items
            </p>
          </div>
